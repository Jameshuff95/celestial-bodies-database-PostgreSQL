...
CREATE TABLE public.galaxy (
    ...
    human_activity boolean NOT NULL
);
...
--
-- Name: main why_pkey; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.main
    ADD CONSTRAINT why_pkey PRIMARY KEY (main_id);
...
ALTER TABLE ONLY public.star
    ADD CONSTRAINT star_star_id_fkey FOREIGN KEY (star_id) REFERENCES public.main(main_id);
